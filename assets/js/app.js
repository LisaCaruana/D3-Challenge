...
//   var yLinearScale = d3.scaleLinear()
//     .domain([d3.min(data, d => d[chosenYAxis]) * .90,
//     d3.max(data, d =>[chosenYAxis]) * 1.05
//   ])
//   .range([0, width]);
//   return yLinearScale
// }
...
//   var healthcare_label = labelsGroupY.append("text")
//     .attr("transform", "rotate(-90)")
//     .attr("y", 0 - margin.left)
//     .attr("x", 0 - (height / 2))
//     .attr("dy", "1em")
...
//   var obesity_label = labelsGroupY.append("text")
//     .attr("transform", "rotate(-90)")
//     .attr("y", 0 - margin.left)
//     .attr("x", 0 - (height / 2))
//     .attr("dy", "1em")
...
//   // Create x axis labels event listener
//   xlabels = circlesGroup.selectAll("text")
//     .on("click", function() {
//       // get value of selection
//       var value = d3.select(this).attr("value");
//       if (value !== chosenXAxis) {
...
//   // ylabels = labelsGroup.selectAll("text")        
//   //   .on("click", function() {
//   //         // get value of selection
//   //         var value = d3.select(this).attr("value");
...
//         if (chosenYAxis === "healthcare_label") {
//           healthcare_label
//             .classed("active", true)
//             .classed("inactive", false);
//           obesity_label
